...
define('SITE_NAME'   , 'Eficiencia Energetica');    // Nombre del sitio
...
define('MENU'      ,  VIEWS.'menuprincipal'.DS);
...
define('FIRMA'       , ASSETS.'firma/');
define('FIRMAENTREGA'       , ASSETS.'firmaEntrega/');
define('PDFENTREGA'       , ASSETS.'PDFEntrega/');

// Credenciales de la base de datos
// Set para conexión local o de desarrollo
define('LDB_ENGINE' , 'mysql');
define('LDB_HOST'   , 'localhost');
define('LDB_NAME'   , 'sistemaimpresora');
...
// CONSTANTES WAZAP
define('WA_COMPANY'     , 'Reporte');
define('WA_DEFAULT_TEXT', sprintf('Hola %%s, Tienes un nuevo %s', WA_COMPANY));